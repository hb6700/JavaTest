...
public class Ex51_interface {
	...
	public static void main(String[] args) {
		...
		// *** 인터페이스는 상속 받는 여러 클래스들을의행동(t하용법, 메소드)들을 통일시키는 역할: 행동규약 정ㅢ
...
//	}
	...
	//추상 메소드(Abstract Method) : 구현부 없이 선언부만 가지는 메소드
	public void click();
}
...
//implements < Mouse{
//M705의 클릭 기능과 동일한 기능 , 제품이 달라서 사용법이 다르다.
//	public void push() {
//		System.out.println("클릭!!");
//	}
