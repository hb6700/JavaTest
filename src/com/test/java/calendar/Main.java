...
public class Main {
	...
	public static void main(String[] args) {
		...
		int lastDate = c.getActualMaximum(Calendar.DATE);	//해당월의 마지막 날짜
		int firstDay = c.get(Calendar.DAY_OF_WEEK);			//1일의 요일(화요일 : 3)
...
//				//일정 출력 : 위에서 출력된 날짜와 동일한 날짜의 일정이 있는지 확인
